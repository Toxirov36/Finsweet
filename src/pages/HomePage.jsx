...
const HomePage = () => {
  return (
    <div>
      {/* Hero */}
      <section className="bg-gray-900 px-4 md:px-8 lg:px-12 py-12 lg:py-20 flex flex-col lg:flex-row items-center gap-8 lg:gap-16 min-h-80">
        <div className="flex-1">
          <div className="w-3 h-3 bg-orange-400 mb-6" />
          <h1 className="text-white text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight mb-4">
        ...
        <div className="flex-1 relative w-full">
          <img src="https://images.unsplash.com/photo-1556761175-4b46a572b786?w=600&auto=format&fit=crop" alt="Finsweet team collaboration" className="rounded-lg w-full object-cover h-56 md:h-72" />
          <div className="absolute -bottom-2 -right-2 w-8 h-20 bg-orange-400 hidden md:block" />
          <div className="absolute top-0 right-0 w-4 h-4 bg-indigo-500 hidden md:block" />
        </div>
      </section>

      {/* Clients */}
      <section className="bg-gray-800 px-4 md:px-8 lg:px-12 py-6 flex flex-col md:flex-row items-center gap-6">
      ...
      {/* About */}
      <AnimatedSection>
        <section className="px-4 md:px-8 lg:px-12 py-12 lg:py-20 bg-white">
          <p className="text-gray-400 text-xs tracking-widest uppercase mb-2">About Us</p>
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
            <div className="flex-1">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-gray-900 leading-tight">The company leads entire webdesign process from concept to delivery.</h2>
            </div>
            <div className="flex-1">
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">The Era Of Technology.</h3>
          ...
          <div className="flex flex-col md:flex-row gap-3 mt-10 mb-8">
            {[
              ...
              <div key={i} className="relative flex-1">
                <img src={src} alt="Office workspace" className="w-full h-40 md:h-52 object-cover rounded" />
          ...
          <div className="flex flex-wrap gap-8 md:gap-12 mt-8">
            {[["1560","+","Project Delivered"],["100","+","Professional"],["950","+","Happy Client"],["10"," yrs","Experience"]].map(([n,s,l])=>(
              <div key={l}>
                <p className="text-3xl font-extrabold text-gray-900"><CountUp end={parseInt(n)} suffix={s} /></p>
                <div className="w-8 h-0.5 bg-orange-400 mt-1 mb-1"/>
                <p className="text-gray-500 text-sm">{l}</p>
              </div>
            ))}
            <div className="ml-auto self-center">
              <Link to="/company" className="flex items-center gap-2 text-indigo-600 font-semibold text-sm">Read about us <ArrowRight /></Link>
            </div>
          </div>
        </section>
      </AnimatedSection>
        ...
        <section className="bg-blue-50 px-4 md:px-8 lg:px-12 py-12 lg:py-20">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
            <div className="flex-1">
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 leading-tight mb-4">We want to get local identification in every corner of the world in this era of global citizenship</h2>
              <p className="text-gray-500 text-sm leading-relaxed">Through True Rich Attended does no end it his mother since real had half every him case in packages enquire we up ecstatic unsatiable saw his giving Remain expense you position concluded.</p>
            </div>
      ...
      <AnimatedSection>
        <section className="bg-orange-50 px-4 md:px-8 lg:px-12 py-12 lg:py-20">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 mb-10">
            <div className="flex-1">
              <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 leading-tight">We build software solutions that solve client's business challenges</h2>
            </div>
            <div className="flex-1 flex items-end">
              <Link to="/service" className="inline-flex items-center gap-2 bg-indigo-600 text-white px-6 py-3 rounded hover:bg-indigo-700 transition-colors">
        ...
        <section className="bg-white px-4 md:px-8 lg:px-12 py-12 lg:py-20">
          <div className="flex flex-col md:flex-row justify-between items-start mb-10 gap-4">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 leading-tight mb-3">The process we are working<br className="hidden md:block"/>With Our client Worldwide</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={p.title} className="border border-gray-100 rounded-lg p-6 relative hover:shadow-md transition-shadow">
        ...
        <section className="bg-white px-4 md:px-8 lg:px-12 py-12 lg:py-16">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
            <div className="flex-1">
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-3">Our customers love what we do</h2>
              ...
              <div className="flex gap-3 mb-3">
                {[1,2,3].map(i=>(
                  <div key={i} className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden">
                    <img src={`https://i.pravatar.cc/40?img=${i+10}`} alt="Customer review avatar" className="w-full h-full object-cover" />
                  </div>
                ))}
              </div>
              <p className="text-gray-500 text-xs">30+ Customer Reviews</p>
            </div>
            <div className="flex-1 relative border-l-4 border-orange-400 pl-6 lg:pl-8">
              <div className="text-indigo-600 text-5xl lg:text-6xl font-serif mb-4">"</div>
              <p className="text-gray-900 text-lg lg:text-xl font-semibold leading-relaxed mb-6">Finsweet has been a wonderful partner to work with. I have been a customer now for the past few months now and I have had nothing but positive experiences!</p>
              <div className="flex items-center gap-3">
                <img src="https://i.pravatar.cc/40?img=15" alt="Johnny Andre avatar" className="w-10 h-10 rounded-full object-cover" />
                <div>
                  <p className="font-bold text-gray-900 text-sm">Johnny Andre</p>
                  <p className="text-gray-400 text-xs">Director, Company</p>
                </div>
                <div className="ml-auto text-indigo-600 font-bold text-xs">CloudScale™</div>
              </div>
            </div>
          </div>
        </section>
      ...
      <AnimatedSection>
        <section className="bg-blue-50 px-4 md:px-8 lg:px-12 py-12 lg:py-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl md:text-2xl font-extrabold text-gray-900">Read our latest blogs & news</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={b.title} className="flex flex-col sm:flex-row gap-4 bg-white rounded-lg p-4">
                <img src={b.img} alt={b.title} className="w-full sm:w-32 h-32 sm:h-24 object-cover rounded" />
                <div>
                  <p className="text-gray-400 text-xs mb-1">{b.date}</p>
                  <h3 className="font-bold text-gray-900 text-sm mb-3">{b.title}</h3>
                  <Link to="/blog" className="flex items-center gap-1 text-indigo-600 text-xs font-semibold">Read More <ArrowRight /></Link>
                </div>
              </div>
            ))}
          </div>
